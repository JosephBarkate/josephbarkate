  ...
  <body data-spy="scroll" data-offset="0" data-target="#theMenu">
	...
	<nav class="menu" id="theMenu">
		<div class="menu-wrap">
			...
			<a href="index.html" onclick="closeMenu()">About</a>
			<a href="index.html" onclick="closeMenu()">Portfolio</a>
			<a href="index.html" onclick="closeMenu()">Contact</a>
	...
	<div id="f">
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-6 col-lg-offset-3">
					<p>Charles Schwab</p>
					<p>Angular Front End Developer</p>
					<p>Languages: Typesript, Javascript, HTML, CSS, Ruby, C#</p>
					<p>Frameworks: Angular 4, Jasmine, Karma, Git, Confluence, Jira</p>
